...
export default function CreateProduct() {
  ...
  const onSubmit = async () => {
    try {
      // Check if imageUrls is empty and set default image
      ...
      await axios.post('/api/create_product', formData, {
      ...
      toast.error(`Failed to create form data ${error}`);
      console.log(error);
    }
  };
